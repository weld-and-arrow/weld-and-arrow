...
A soteriological metaphysics with no substrate and no value: take one emptiness posit and follow what it forces for karma, action, and awakening. There is no value anywhere in the system — the karma loop and the resonance that grades it are all there is, and all that karma is.
...
| **engi / inga** — directedness with no moral ground; the blind arrow. | **shu** — practice (gyōji); the weld at act-time, direction bound along the blind arrow; not-obscure (不昧). |
...
- **shugenjō** = shu + genjō — Row 3 practice as Row 1 manifestation: genjō is nothing but practice run scaffold-free.
- **shushō** = shu + shō — the weld (below). Here shō is *not* genjō but the floor's non-attaining middle: realization as not-fall, anātman. Practice and realization are non-dual (shushō-ittō).
...
*With thanks to Claude (Anthropic) — a sparring partner across several revisions of this draft, and midwife to deeper resonances.*
