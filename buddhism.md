...
Two guards hold the line. The agent resists reduction by being *more* thoroughly empty, not by being a special substance — said otherwise, a soul is re-smuggled. And it's not a Moorean non-natural fact: the reduction is malformed *because its base is empty* — a dissolutionist reading, and the honest one on a self-emptying floor.

## Tiering

The grid's joints are scaffold; genjō names where the scaffold is kicked away, not a separate ultimate row. 

## Disclaimers

The tiering and kannō-sōe are conventional and my own — contra Dōgen, who keeps all ultimate.
